...
public class AwsSnsService {
    ...
    public String publish(SnsPublishRequestDto requestDto, List<String> serviceList) {
        ...
        try {
            ...
            throw new MemberServiceException(MemberErrorCode.BAD_REQUEST_VALIDATION);
        }
        log.info(message);
    ...
    public String publish(SnsPublishEtoosRequestDto requestDto, List<String> serviceList) {
        String message, strServiceList = "";
        try {
            message = objectMapper.writeValueAsString(requestDto);
            strServiceList = objectMapper.writeValueAsString(serviceList);
    ...
    public String publish(SnsPublishCommonRequestDto requestDto, List<String> serviceList) {
        String message, strServiceList = "";
        try {
            message = objectMapper.writeValueAsString(requestDto);
            strServiceList = objectMapper.writeValueAsString(serviceList);
